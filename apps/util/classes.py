    ...
    def txt_to_rgba(value):
        ...
        if value_type > 0:
            ...
            if len(array_values) == 3:
                #RGB
                return rgb([array_values[0], array_values[1], array_values[2]])
            if len(array_values) == 4:
                #RGBA
                return rgb([array_values[0], array_values[1], array_values[2]], a=array_values[3])
